...
- Se asennetaan komennolla "sudo apt-get -y install apache2" ja sitten tehdään oletussivu komennolla "echo "Default"|sudo tee /var/www/html/index.html"
  jossa putki ohjaa echo komennon seuraavalle annetulle komennolle joka on tässä tapauksessa "sudo tee..."
...
- Tein HTTP GET pyynnön palvelimen etusivulle, jonka määrittää merkki "/"
